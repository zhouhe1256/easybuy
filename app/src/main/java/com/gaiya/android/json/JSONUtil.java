package com.gaiya.android.json;


import com.gaiya.android.json.annotation.Ignore;
...
public final class JSONUtil {
    ...
    static class JSONField {
        ...
        public JSONField(Field field) {
            ...
            com.gaiya.android.json.annotation.JSON json = field.getAnnotation(com.gaiya.android.json.annotation.JSON.class);
            if (json != null) {
                name = json.name();
            } else {
                name = field.getName();
            ...
            com.gaiya.android.json.annotation.JSONCollection jsonCollection = field
                    .getAnnotation(com.gaiya.android.json.annotation.JSONCollection.class);
