package com.gaiya.android.util;
...
public class Logger {
    ...
    private static com.gaiya.android.util.log.ILogger defaultLogger = new com.gaiya.android.util.log.PrintToLogCatLogger();
    ...
    public static void setLogger(com.gaiya.android.util.log.ILogger defaultLogger) {
    ...
    private static void printLogger(com.gaiya.android.util.log.ILogger logger, Level level, String tag,
                                    String message) {
        switch (level) {
            case VERBOSE:
