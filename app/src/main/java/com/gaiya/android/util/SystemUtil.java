...
public class SystemUtil {
    ...
    public static String getMacAddress(Context context) {
        ...
        com.gaiya.android.util.Logger.i(TAG, "MAC：" + mac);
        return mac;
    }
    ...
    public static String getBootTimeString() {
        ...
        int h = (int) ((ut / 3600));
        int m = (int) ((ut / 60) % 60);
        com.gaiya.android.util.Logger.i(TAG, h + ":" + m);
        return h + ":" + m;
    }
    ...
    public static String printSystemInfo() {
        ...
        com.gaiya.android.util.Logger.i(TAG, sb.toString());
        return sb.toString();
    }
    ...
    public static String printCpuInfo() {
        ...
        com.gaiya.android.util.Logger.i(TAG, "_______  CPU :   \n" + info);
        return info;
    }
    ...
    public static String printMemInfo() {
        ...
        com.gaiya.android.util.Logger.i(TAG, "_______  内存信息:   \n" + info);
        return info;
    }
