...
import com.gaiya.android.async.ICallbackExecutor;
import com.gaiya.android.async.ICancellable;
import com.gaiya.android.async.IPromise;
import com.gaiya.android.cache.ICache;
...
public class HttpClient implements ICancellable {
    ...
    private com.gaiya.android.remote.HttpSettings httpSettings = new com.gaiya.android.remote.HttpSettings();
    ...
    public HttpClient settings(com.gaiya.android.remote.HttpSettings settings) {
        this.httpSettings = new com.gaiya.android.remote.HttpSettings(settings);
        return this;
    }
...
public HttpClient isCache(boolean f){
    ...
    private void setupDeferredOptions(com.gaiya.android.async.Deferred deferred) {
        com.gaiya.android.remote.HttpSettings o = httpSettings;
    ...
    public com.gaiya.android.async.Deferred run(final ICallbackExecutor callbackExecutor) {
        final com.gaiya.android.async.Deferred deferred = new com.gaiya.android.async.Deferred(callbackExecutor);
    ...
    private Arguments buildArguments(byte[] data) throws Exception {
        ...
        com.gaiya.android.remote.ContentType contentType = new com.gaiya.android.remote.ContentType(getMime(), getCharset());
    ...
    class Fetcher implements Runnable {
        private final com.gaiya.android.async.Deferred deferred;
        private final ICallbackExecutor callbackExecutor;

        private volatile boolean started;
        private HttpURLConnection connection;

        public Fetcher(com.gaiya.android.async.Deferred deferred, ICallbackExecutor callbackExecutor) {
        ...
        public void run() {
            ...
            try {
                ...
                if (deferred.getState() == com.gaiya.android.async.State.PENDING) {
                    deferred.resolved(arguments);
                }
            } catch (Exception e) {
                if (isCancelled()) {
        ...
        private boolean isCancelled() {
            return deferred.getState() == com.gaiya.android.async.State.CANCELED;
        }
