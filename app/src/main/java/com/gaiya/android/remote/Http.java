...
public class Http {
    ...
    static {
        ...
        com.gaiya.android.async.LooperCallbackExecutor callbackExecutor = new com.gaiya.android.async.LooperCallbackExecutor();
    ...
    public <K, V> Http cache(com.gaiya.android.cache.ICache<K, V> cache) {
    ...
    public Http callbackExecutor(com.gaiya.android.async.ICallbackExecutor callbackExecutor) {
     ...
     * @return
     */
    public Http start(com.gaiya.android.async.ICallback callback) {
        httpSettings.addCallback(HttpOption.START_CALLBACK, callback);
        return this;
    }

    public Http progress(com.gaiya.android.async.ICallback callback) {
        httpSettings.addCallback(HttpOption.PROGRESS_CALLBACK, callback);
        return this;
    }

    public Http done(com.gaiya.android.async.ICallback callback) {
        httpSettings.addCallback(HttpOption.DONE_CALLBACK, callback);
        return this;
    }

    public Http fail(com.gaiya.android.async.ICallback callback) {
        httpSettings.addCallback(HttpOption.FAIL_CALLBACK, callback);
        return this;
    }

    public Http always(com.gaiya.android.async.ICallback callback) {
     ...
     * @return
     */
    public Http complete(com.gaiya.android.async.ICallback callback) {
