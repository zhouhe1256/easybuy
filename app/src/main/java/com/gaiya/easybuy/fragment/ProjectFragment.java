...
public class ProjectFragment extends Fragment implements View.OnClickListener {
    ...
    private void initData() {
      ...
      //  url = ApiUrl.HOST_HTML_URL;
        url= GApplication.getInstance().getPropertyModel().getProject_url();
        starturl = url;
        ...
        if (url.startsWith(GApplication.getInstance().getPropertyModel().getProject_url())) {
    ...
    public void initEvent() {
        ...
        String cacheDirPath = getActivity().getFilesDir().getAbsolutePath()+"easybuy_1";
    ...
    private class WebViewClient extends android.webkit.WebViewClient {
        @Override
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            Logger.i("usss",url+","+starturl+url.equals(starturl));
            String u = null;
            if(!b){
                b = true;
                u = url;
