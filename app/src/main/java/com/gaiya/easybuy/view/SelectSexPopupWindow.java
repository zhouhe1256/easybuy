...
public class SelectSexPopupWindow extends PopupWindow {
    ...
    public SelectSexPopupWindow(Activity context, final SelectResult selectResult) {
        super(context);
        initAnim();
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.select_sex_popup_window, null);
