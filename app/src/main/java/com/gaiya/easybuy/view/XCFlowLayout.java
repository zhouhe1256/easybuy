...
public class XCFlowLayout extends ViewGroup{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
       ...
       // heightMeasureSpec = MeasureSpec.makeMeasureSpec(height_, MeasureSpec.EXACTLY);
        ...
        for(int i = 0;i < childCount; i ++){
            ...
            //换行时候
            if(lineWidth + childWidth > sizeWidth-20){
                //对比得到最大的宽度
      ...
      //  heightMeasureSpec = MeasureSpec.makeMeasureSpec(height+lineHeight+10, MeasureSpec.EXACTLY);
        //wrap_content
//        setMeasuredDimension(modeWidth == MeasureSpec.EXACTLY ? sizeWidth : width,
//                modeHeight == MeasureSpec.EXACTLY ? sizeHeight : height+lineHeight+10);
        height += lineHeight+20;
