...
//                    mFocusChangeListener);
        ...
        // LayoutParams lpSelectedImage = new
        ...
        if (flag == true) {
            flag = false;
            mItems.get(pos).requestFocus();
            mItems.get(pos).performClick();
        }
        // setSelectedPos(pos);
    }
    ...
    public void setSelectedPosition(int i) {
        if (mItems != null && mItems.size() > i) {
            ...
            // mSelectedListener.OnItemSelected(null, i);
            // animation = new TranslateAnimation(oldIndex * itemWidth,
            // itemWidth
            // * i, 0, 0);
    ...
    private int pos = 0;
    public void getChildView(int pos) {
        flag=true;
       // ((TabNavigateItem) mItems.get(pos)).performClick();
    }
